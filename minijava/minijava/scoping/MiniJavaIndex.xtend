...
class MiniJavaIndex {
	...
	def getVisibleClassesDescriptions(EObject o) {
		o.getVisibleEObjectDescriptions(MiniJavaPackage.eINSTANCE.getClassDecl())
	}
	...
	def getExportedClassesEObjectDescriptions(EObject o) {
		o.getResourceDescription.getExportedObjectsByType(MiniJavaPackage.eINSTANCE.getClassDecl())
	}
}